...
class OAuth {
    ...
    public function authenticate(){
        if($this->access_token != null){
            $query = "SELECT * FROM ezhil_apicourse.session WHERE access_token = '$this->access_token';";
    ...
    public function newSession($valid_for = 7200, $reference_token = 'auth_grant'){
        ...
        $query = "INSERT INTO `ezhil_apicourse`.`session` (`username`, `access_token`, `refresh_token`, `valid_for`, `reference_token`) 
